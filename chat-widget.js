// Chat Widget Script - Versió 4.8 - COMPLETAMENT CORREGIT
(function() {
           ...
           categories: {
               ...
               "informacion": {
                   ...
                   options: {
                       ...
                       "documentacion": { title: "Documentació necessària per tràmits", message: "Quina documentació necessito per fer tràmits?" }
                   }
               },
               "otras": {
   ...
   function formatText(text) {
       ...
       // Gestió de salts de línia i paràgrafs
   ...
   async function sendMessage(message) {
       // Si no tenim sessió, crear-ne una
       if (!currentSessionId) {
       ...
       try {
           ...
           // Scroll per mostrar l'últim missatge
   ...
   function showChatInterface() {
       ...
       // Canviar a la interfície de xat
